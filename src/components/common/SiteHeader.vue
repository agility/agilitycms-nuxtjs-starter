			...
			<div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
				...
				<div class="-mr-2 -my-2 md:hidden">
					<button
						@click="toggle"
						type="button"
						class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out h-4 w-4"
					>
						<svg
							class="h-6 w-6"
						...
						<div class="flex items-center justify-end">
							<div class="-mr-2">
								<button
									...
									type="button"
									class="inline-flex items-center justify-center p-2 h-4 w-4 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-300"
								>
									<svg
										class="h-6 w-6"
										xmlns="http://www.w3.org/2000/svg"
							...
							<nav class="grid gap-y-8">
								<template v-for="link in links">
									<a
										:href="link.path"
										:key="link.path"
										class="-m-3 p-3 flex items-center h-4 w-4 space-x-3 rounded-md hover:bg-gray-50 transition duration-300"
										@click="toggle"
									>
										<svg
