			...
			<div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
				...
				<nav class="hidden md:flex space-x-10">
					<template v-for="navitem in links">
						...
						<NuxtLink :key="navitem.path" :to="navitem.path" class="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
							{{navitem.text}}
						</NuxtLink>
					</template>
				</nav>
						...
						<div>
							<nav class="grid gap-y-8">
								<template v-for="navitem in links">
									...
									<NuxtLink :key="navitem.path" :to="navitem.path" class="-m-3 p-3 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150">
...
export default {
	...
	computed: {
		contentItem() {
			return this.globalHeader.contentItem.fields
		},
		links() {
			return this.globalHeader.links
		}
